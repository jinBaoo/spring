...
named `com.demo.app.Config` that is automatically used to load the `ApplicationContext` for the test
class:
...
----
	...
	// static nested com.demo.app.Config class
	class OrderServiceTest {

		@Configuration
		static class com.demo.app.Config {
...
----
<1> Loading configuration information from the nested `com.demo.app.Config` class.

[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
.Kotlin
----
	@SpringJUnitConfig <1>
	// ApplicationContext will be loaded from the nested com.demo.app.Config class
	class OrderServiceTest {
